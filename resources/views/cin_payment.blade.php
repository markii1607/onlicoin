                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-10">
                                <div class="text-center" id="coin-in-nav">
                                    <a href="{{ route('auth-cin_remittance') }}"><img src="assets/images/samp.png" alt=""></a>
                                    <a href="{{ route('auth-cin_manage_funds') }}"><img src="assets/images/samp.png" alt=""></a>
                                    <a href="{{ route('auth-cin_payment') }}"><img src="assets/images/samp.png" alt=""></a>
                                    <a href="{{ route('auth-cin_buy_oct') }}"><img src="assets/images/samp.png" alt=""></a>
                                    <h3><b>PAYMENT</b></h3>
                                </div>
                                <div class="row">
                                    <div class="col-sm-4">
